Folder contains scripts used for training and testing of machine-learning models for prediction of IBD (CD or UC) and separation between UC and CD using antibody panel. 
